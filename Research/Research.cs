...
public static partial class Research
{
    ...
    private delegate bool IsMatchDelegate(long number);
    private static void FindMaxOddSystem(Client client, string extra)
    {
        DoFindMaxSystem(client, Numbers.IsOdd);
    }
    private static void FindMaxEvenSystem(Client client, string extra)
    {
        DoFindMaxSystem(client, Numbers.IsEven);
    }
    private static void FindMaxGeometricSystem(Client client, string extra)
    {
        DoFindMaxSystem(client, Numbers.IsTriangular);
        DoFindMaxSystem(client, Numbers.IsSquare);
        DoFindMaxSystem(client, Numbers.IsPentagonal);
        DoFindMaxSystem(client, Numbers.IsHexagonal);
        DoFindMaxSystem(client, Numbers.IsHeptagonal);
        DoFindMaxSystem(client, Numbers.IsOctagonal);
        DoFindMaxSystem(client, Numbers.IsNonagonal);
        DoFindMaxSystem(client, Numbers.IsDecagonal);
        DoFindMaxSystem(client, Numbers.IsHendecagonal);
        DoFindMaxSystem(client, Numbers.IsDodecagonal);
        DoFindMaxSystem(client, Numbers.IsTridecagonal);
        DoFindMaxSystem(client, Numbers.IsTetradecagonal);
        DoFindMaxSystem(client, Numbers.IsPentadecagonal);
        DoFindMaxSystem(client, Numbers.IsHexadecagonal);
        DoFindMaxSystem(client, Numbers.IsHeptadecagonal);
        DoFindMaxSystem(client, Numbers.IsOctadecagonal);
        DoFindMaxSystem(client, Numbers.IsNonadecagonal);
        DoFindMaxSystem(client, Numbers.IsIcosagonal);
        DoFindMaxSystem(client, Numbers.IsIcosihenagonal);
        DoFindMaxSystem(client, Numbers.IsIcosidigonal);
        DoFindMaxSystem(client, Numbers.IsIcositrigonal);
        DoFindMaxSystem(client, Numbers.IsIcositetragonal);
        DoFindMaxSystem(client, Numbers.IsCenteredTriangular);
        DoFindMaxSystem(client, Numbers.IsCenteredSquare);
        DoFindMaxSystem(client, Numbers.IsCenteredPentagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredHexagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredHeptagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredOctagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredNonagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredDecagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredHendecagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredDodecagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredTridecagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredTetradecagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredPentadecagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredHexadecagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredHeptadecagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredOctadecagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredNonadecagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredIcosagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredIcosihenagonal);
        DoFindMaxSystem(client, Numbers.IsCenteredIcosidigonal);
        DoFindMaxSystem(client, Numbers.IsCenteredIcositrigonal);
        DoFindMaxSystem(client, Numbers.IsCenteredIcositetragonal);
        DoFindMaxSystem(client, Numbers.IsTetrahedral);
        DoFindMaxSystem(client, Numbers.IsPyramidal);
        DoFindMaxSystem(client, Numbers.IsCubic);
    }
    private static void FindMaxPrimeSystem(Client client, string extra)
    {
        DoFindMaxSystem(client, Numbers.IsPrime);
    }
    private static void FindMaxAdditivePrimeSystem(Client client, string extra)
    {
        DoFindMaxSystem(client, Numbers.IsAdditivePrime);
    }
    private static void FindMaxPurePrimeSystem(Client client, string extra)
    {
        DoFindMaxSystem(client, Numbers.IsPurePrime);
    }
    private static void FindMaxCompositeSystem(Client client, string extra)
    {
        DoFindMaxSystem(client, Numbers.IsComposite);
    }
    private static void FindMaxAdditiveCompositeSystem(Client client, string extra)
    {
        DoFindMaxSystem(client, Numbers.IsAdditiveComposite);
    }
    private static void FindMaxPureCompositeSystem(Client client, string extra)
    {
        DoFindMaxSystem(client, Numbers.IsPureComposite);
    }
    private static void FindMaxMersennePrimesSystem(Client client, string extra)
    {
        DoFindMaxSystem(client, Numbers.IsMersennePrime);
    }
    private static void FindMaxFibonacciSystem(Client client, string extra)
    {
        DoFindMaxSystem(client, Numbers.IsFibonacci);
    }
    private static void FindMaxLog2System(Client client, string extra)
    {
        DoFindMaxSystem(client, Numbers.IsLog2);
    }
    private static void FindMaxLog10System(Client client, string extra)
    {
        DoFindMaxSystem(client, Numbers.IsLog10);
    }
    private static void DoFindMaxSystem(Client client, IsMatchDelegate IsMatchMethod)
    {
        if (client == null) return;
        if (client.Selection == null) return;
        ...
        bool BackupIsDynamic = client.IsDynamic;
        ...
        string MatchingType = IsMatchMethod.Method.Name.Remove(0, 2); // remove "Is"
        string filename = "FindMax" + MatchingType + "System" + Globals.OUTPUT_FILE_EXT;

        StringBuilder str = new StringBuilder();
        // value1
        str.Append("Normal == chapter value with bismAllah and with initial letters (if any)." + "\r\n");
        // value2
        str.Append("NoBism == chapter value without bismAllah but with initial letters (if any)." + "\r\n");
        // value3
        str.Append("NoInit == chapter value with bismAllah but without initial letters (if any)." + "\r\n");
        // value4
        str.Append("NoBoth == chapter value without bismAllah and without initial letters (if any)." + "\r\n");
        str.Append("\r\n");

        long maxmax_matching_value1_count = 0;
        long maxmax_matching_value2_count = 0;
        long maxmax_matching_value3_count = 0;
        long maxmax_matching_value4_count = 0;
        string maxmax_matching_value1_count_numerology_system_name = "";
        string maxmax_matching_value2_count_numerology_system_name = "";
        string maxmax_matching_value3_count_numerology_system_name = "";
        string maxmax_matching_value4_count_numerology_system_name = "";
        string maxmax_matching_value1_count_dynamic_add_flags = "false, false, false, false, false, false, false, false";
        string maxmax_matching_value2_count_dynamic_add_flags = "false, false, false, false, false, false, false, false";
        string maxmax_matching_value3_count_dynamic_add_flags = "false, false, false, false, false, false, false, false";
        string maxmax_matching_value4_count_dynamic_add_flags = "false, false, false, false, false, false, false, false";
        ...
        for (int i = 0; i < PERMUTATIONS; i++)
        {
            ...
            long max_matching_value1_count = 0;
            long max_matching_value2_count = 0;
            long max_matching_value3_count = 0;
            long max_matching_value4_count = 0;
            string max_matching_value1_numerology_system_name = "";
            string max_matching_value2_numerology_system_name = "";
            string max_matching_value3_numerology_system_name = "";
            string max_matching_value4_numerology_system_name = "";
            DoDoFindMaxSystem(client,
                                  IsMatchMethod,
                                  filename,
                                  numerology_system,
                                  ref max_matching_value1_count,
                                  ref max_matching_value2_count,
                                  ref max_matching_value3_count,
                                  ref max_matching_value4_count,
                                  ref max_matching_value1_numerology_system_name,
                                  ref max_matching_value2_numerology_system_name,
                                  ref max_matching_value3_numerology_system_name,
                                  ref max_matching_value4_numerology_system_name);

            if (maxmax_matching_value1_count < max_matching_value1_count)
            {
                maxmax_matching_value1_count = max_matching_value1_count;
                maxmax_matching_value1_count_numerology_system_name = max_matching_value1_numerology_system_name;
                maxmax_matching_value1_count_dynamic_add_flags = client.IsDynamic.ToString() + "\t" + client.AddToLetterLNumber.ToString() + "\t" + client.AddToLetterWNumber.ToString() + "\t" + client.AddToLetterVNumber.ToString() + "\t" + client.AddToLetterCNumber.ToString() + "\t" + client.AddToLetterLDistance.ToString() + "\t" + client.AddToLetterWDistance.ToString() + "\t" + client.AddToLetterVDistance.ToString() + "\t" + client.AddToLetterCDistance.ToString() + "\t" + client.AddToWordWNumber.ToString() + "\t" + client.AddToWordVNumber.ToString() + "\t" + client.AddToWordCNumber.ToString() + "\t" + client.AddToWordWDistance.ToString() + "\t" + client.AddToWordVDistance.ToString() + "\t" + client.AddToWordCDistance.ToString() + "\t" + client.AddToVerseVNumber.ToString() + "\t" + client.AddToVerseCNumber.ToString() + "\t" + client.AddToVerseVDistance.ToString() + "\t" + client.AddToVerseCDistance.ToString() + "\t" + client.AddToChapterCNumber.ToString();
            }
            if (maxmax_matching_value2_count < max_matching_value2_count)
            {
                maxmax_matching_value2_count = max_matching_value2_count;
                maxmax_matching_value2_count_numerology_system_name = max_matching_value2_numerology_system_name;
                maxmax_matching_value2_count_dynamic_add_flags = client.IsDynamic.ToString() + "\t" + client.AddToLetterLNumber.ToString() + "\t" + client.AddToLetterWNumber.ToString() + "\t" + client.AddToLetterVNumber.ToString() + "\t" + client.AddToLetterCNumber.ToString() + "\t" + client.AddToLetterLDistance.ToString() + "\t" + client.AddToLetterWDistance.ToString() + "\t" + client.AddToLetterVDistance.ToString() + "\t" + client.AddToLetterCDistance.ToString() + "\t" + client.AddToWordWNumber.ToString() + "\t" + client.AddToWordVNumber.ToString() + "\t" + client.AddToWordCNumber.ToString() + "\t" + client.AddToWordWDistance.ToString() + "\t" + client.AddToWordVDistance.ToString() + "\t" + client.AddToWordCDistance.ToString() + "\t" + client.AddToVerseVNumber.ToString() + "\t" + client.AddToVerseCNumber.ToString() + "\t" + client.AddToVerseVDistance.ToString() + "\t" + client.AddToVerseCDistance.ToString() + "\t" + client.AddToChapterCNumber.ToString();
            }
            if (maxmax_matching_value3_count < max_matching_value3_count)
            {
                maxmax_matching_value3_count = max_matching_value3_count;
                maxmax_matching_value3_count_numerology_system_name = max_matching_value3_numerology_system_name;
                maxmax_matching_value3_count_dynamic_add_flags = client.IsDynamic.ToString() + "\t" + client.AddToLetterLNumber.ToString() + "\t" + client.AddToLetterWNumber.ToString() + "\t" + client.AddToLetterVNumber.ToString() + "\t" + client.AddToLetterCNumber.ToString() + "\t" + client.AddToLetterLDistance.ToString() + "\t" + client.AddToLetterWDistance.ToString() + "\t" + client.AddToLetterVDistance.ToString() + "\t" + client.AddToLetterCDistance.ToString() + "\t" + client.AddToWordWNumber.ToString() + "\t" + client.AddToWordVNumber.ToString() + "\t" + client.AddToWordCNumber.ToString() + "\t" + client.AddToWordWDistance.ToString() + "\t" + client.AddToWordVDistance.ToString() + "\t" + client.AddToWordCDistance.ToString() + "\t" + client.AddToVerseVNumber.ToString() + "\t" + client.AddToVerseCNumber.ToString() + "\t" + client.AddToVerseVDistance.ToString() + "\t" + client.AddToVerseCDistance.ToString() + "\t" + client.AddToChapterCNumber.ToString();
            }
            if (maxmax_matching_value4_count < max_matching_value4_count)
            {
                maxmax_matching_value4_count = max_matching_value4_count;
                maxmax_matching_value4_count_numerology_system_name = max_matching_value4_numerology_system_name;
                maxmax_matching_value4_count_dynamic_add_flags = client.IsDynamic.ToString() + "\t" + client.AddToLetterLNumber.ToString() + "\t" + client.AddToLetterWNumber.ToString() + "\t" + client.AddToLetterVNumber.ToString() + "\t" + client.AddToLetterCNumber.ToString() + "\t" + client.AddToLetterLDistance.ToString() + "\t" + client.AddToLetterWDistance.ToString() + "\t" + client.AddToLetterVDistance.ToString() + "\t" + client.AddToLetterCDistance.ToString() + "\t" + client.AddToWordWNumber.ToString() + "\t" + client.AddToWordVNumber.ToString() + "\t" + client.AddToWordCNumber.ToString() + "\t" + client.AddToWordWDistance.ToString() + "\t" + client.AddToWordVDistance.ToString() + "\t" + client.AddToWordCDistance.ToString() + "\t" + client.AddToVerseVNumber.ToString() + "\t" + client.AddToVerseCNumber.ToString() + "\t" + client.AddToVerseVDistance.ToString() + "\t" + client.AddToVerseCDistance.ToString() + "\t" + client.AddToChapterCNumber.ToString();
            }

            System.Diagnostics.Process.Start(s_research_directory);
        }

        str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");
        str.Append("Total" + "\t" + "Normal" + "\t" + "NoBism" + "\t" + "NoInit" + "\t" + "NoBoth" + "\t" + "Dynamic" + "\t" + "Letter" + "\t" + "Word" + "\t" + "Verse" + "\t" + "Chapter" + "\t" + "TextMode" + "\t" + "LetterOrder" + "\t" + "LetterValues" + "\r\n");
        str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");
        str.Append("MaxMax" + "\t" + maxmax_matching_value1_count + "\t" + "\t" + "\t" + "\t" + maxmax_matching_value1_count_dynamic_add_flags + "\t" + maxmax_matching_value1_count_numerology_system_name.Replace("_", "\t") + "\r\n");
        str.Append("MaxMax" + "\t" + "\t" + maxmax_matching_value2_count + "\t" + "\t" + "\t" + maxmax_matching_value2_count_dynamic_add_flags + "\t" + maxmax_matching_value2_count_numerology_system_name.Replace("_", "\t") + "\r\n");
        str.Append("MaxMax" + "\t" + "\t" + "\t" + maxmax_matching_value3_count + "\t" + "\t" + maxmax_matching_value3_count_dynamic_add_flags + "\t" + maxmax_matching_value3_count_numerology_system_name.Replace("_", "\t") + "\r\n");
        str.Append("MaxMax" + "\t" + "\t" + "\t" + "\t" + maxmax_matching_value4_count + "\t" + maxmax_matching_value4_count_dynamic_add_flags + "\t" + maxmax_matching_value4_count_numerology_system_name.Replace("_", "\t") + "\r\n");
        str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");

        filename = filename.Insert(filename.Length - 4, "_" + maxmax_matching_value1_count + "." + maxmax_matching_value2_count + "." + maxmax_matching_value3_count + "." + maxmax_matching_value4_count);
        string path = s_research_directory + "/" + filename;
        PublicStorage.SaveText(path, str.ToString());
        PublicStorage.DisplayFile(path);
        ...
        Client.UpdateNumerologySystems(client.TextMode, text, client.IsDynamic);
    ...
    private static void DoDoFindMaxSystem(Client client, IsMatchDelegate IsMatchMethod,
                                              string filename,
                                              NumerologySystem numerology_system,
                                              ref long max_matching_value1_count,
                                              ref long max_matching_value2_count,
                                              ref long max_matching_value3_count,
                                              ref long max_matching_value4_count,
                                              ref string max_matching_value1_count_numerology_system_name,
                                              ref string max_matching_value2_count_numerology_system_name,
                                              ref string max_matching_value3_count_numerology_system_name,
                                              ref string max_matching_value4_count_numerology_system_name)
    {
        if (client == null) return;
        if (client.Selection == null) return;

        string current_dynamic_add_bits = (client.IsDynamic ? 1 : 0).ToString() + "\t" + (client.AddToLetterLNumber ? 1 : 0).ToString() + "\t" + (client.AddToLetterWNumber ? 1 : 0).ToString() + "\t" + (client.AddToLetterVNumber ? 1 : 0).ToString() + "\t" + (client.AddToLetterCNumber ? 1 : 0).ToString() + "\t" + (client.AddToLetterLDistance ? 1 : 0).ToString() + "\t" + (client.AddToLetterWDistance ? 1 : 0).ToString() + "\t" + (client.AddToLetterVDistance ? 1 : 0).ToString() + "\t" + (client.AddToLetterCDistance ? 1 : 0).ToString() + "\t" + (client.AddToWordWNumber ? 1 : 0).ToString() + "\t" + (client.AddToWordVNumber ? 1 : 0).ToString() + "\t" + (client.AddToWordCNumber ? 1 : 0).ToString() + "\t" + (client.AddToWordWDistance ? 1 : 0).ToString() + "\t" + (client.AddToWordVDistance ? 1 : 0).ToString() + "\t" + (client.AddToWordCDistance ? 1 : 0).ToString() + "\t" + (client.AddToVerseVNumber ? 1 : 0).ToString() + "\t" + (client.AddToVerseCNumber ? 1 : 0).ToString() + "\t" + (client.AddToVerseVDistance ? 1 : 0).ToString() + "\t" + (client.AddToVerseCDistance ? 1 : 0).ToString() + "\t" + (client.AddToChapterCNumber ? 1 : 0).ToString();

        // augment filename with current_dynamic_add_bits
        filename = filename.Insert(0, current_dynamic_add_bits + "_");
        ...
        List<string> numerology_system_names = new List<string>(Client.NumerologySystems.Keys);
        foreach (string numerology_system_name in numerology_system_names)
        {
            if (numerology_system_name.Contains("Images")) continue;
            if (numerology_system_name.Contains("English")) continue;

            if ((client.TextMode != null) && (client.TextMode.StartsWith("Simplified")))
            {
                Dictionary<char, long> numerology_system = Client.NumerologySystems[numerology_system_name];

                if (IsDynamic)
                {
                    Client.UpdateNumerologySystems(client.TextMode, client.Selection.GetText(client.TextMode), true);
                }
                else
                {
                    Client.UpdateNumerologySystems(client.TextMode, Book.Instance.GetText(client.TextMode), false);
                }
                ...
                str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");
                str.Append("Chapter" + "\t" + "#" + "\t"
                            + "Normal" + "\t" + MatchingType + "\t" + "NoBism" + "\t" + MatchingType + "\t" + "NoInit" + "\t" + MatchingType + "\t" + "NoBoth" + "\t" + MatchingType + "\t"
                            + "Dynamic" + "\t" + "Letter" + "\t" + "Word" + "\t" + "Verse" + "\t" + "Chapter" + "\t" + "TextMode" + "\t" + "LetterOrder" + "\t" + "LetterValues" + "\r\n");
                str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");

                long matching_value1_count = 0;
                long matching_value2_count = 0;
                long matching_value3_count = 0;
                long matching_value4_count = 0;
                ...
                for (int c = 0; c < chapters.Count; c++)
                {
                    if (IsDynamic)
                    {
                        ...
                        List<int> indexes = new List<int>() { c };
                        client.Selection = new Selection(client.Book, scope, indexes);
                        Client.UpdateNumerologySystems(client.TextMode, client.Selection.GetText(client.TextMode), client.IsDynamic);
                    }

                    str.Append(chapters[c].Name + "\t");
                    str.Append(chapters[c].Number.ToString() + "\t");

                    long value1 = 0; // all verses
                    for (int v = 0; v < chapters[c].Verses.Count; v++)
                    {
                        value1 += chapters[c].Verses[v].Value;
                    }
                    str.Append(value1.ToString() + "\t");
                    if (IsMatchMethod(value1))
                    {
                        matching_value1_count++;
                        str.Append("1" + "\t");
                    }
                    else
                    {
                    ...
                    long value2 = 0; // without bismAllah
                    for (int v = 0; v < chapters[c].Verses.Count; v++)
                    {
                        value2 += chapters[c].Verses[v].Value;
                        if (v == 0)
                        {
                            if ((c != 0) && (c != 8))
                            {
                                value2 -= client.CalculateValue(chapters[0].Verses[0].Text);
                            }
                        }
                    }
                    str.Append(value2.ToString() + "\t");
                    if (IsMatchMethod(value2))
                    {
                        matching_value2_count++;
                        str.Append("1" + "\t");
                    }
                    else
                    {
                    ...
                    long value3 = 0; // without initial letters (if any)
                    for (int v = 0; v < chapters[c].Verses.Count; v++)
                    {
                        value3 += chapters[c].Verses[v].Value;
                        if (v == 0)
                        {
                            if ((c == 1) || (c == 2) || (c == 28) || (c == 29) || (c == 30) || (c == 31))
                            {
                                value3 -= client.CalculateValue("الم");
                            }
                            else if ((c == 6))
                            {
                                value3 -= client.CalculateValue("المص");
                            }
                            else if ((c == 9) || (c == 10) || (c == 11) || (c == 13) || (c == 14))
                            {
                                value3 -= client.CalculateValue("الر");
                            }
                            else if ((c == 12))
                            {
                                value3 -= client.CalculateValue("المر");
                            }
                            else if ((c == 18))
                            {
                                value3 -= client.CalculateValue("كهيعص");
                            }
                            else if ((c == 19))
                            {
                                value3 -= client.CalculateValue("طه");
                            }
                            else if ((c == 25) || (c == 27))
                            {
                                value3 -= client.CalculateValue("طسم");
                            }
                            else if ((c == 26))
                            {
                                value3 -= client.CalculateValue("طس");
                            }
                            else if ((c == 35))
                            {
                                value3 -= client.CalculateValue("يس");
                            }
                            else if ((c == 36))
                            {
                                value3 -= client.CalculateValue("ص");
                            }
                            else if ((c == 39) || (c == 40) || (c == 41) || (c == 42) || (c == 43) || (c == 44) || (c == 45))
                            {
                                value3 -= client.CalculateValue("حم");
                            }
                            else if ((c == 49))
                            {
                                value3 -= client.CalculateValue("ق");
                            }
                            else if ((c == 67))
                            {
                                value3 -= client.CalculateValue("ن");
                            }
                        }
                        else if (v == 1)
                        {
                            if ((c == 41)) // in chapter 42, verse 2
                            {
                                value3 -= client.CalculateValue("عسق");
                            }
                        }
                    }
                    str.Append(value3.ToString() + "\t");
                    if (IsMatchMethod(value3))
                    {
                        matching_value3_count++;
                        str.Append("1" + "\t");
                    }
                    else
                    {
                    ...
                    long value4 = 0; // without bismAllah and without initial letters (if any)
                    for (int v = 0; v < chapters[c].Verses.Count; v++)
                    {
                        value4 += chapters[c].Verses[v].Value;

                        if (v == 0)
                        {
                            if ((c != 0) && (c != 8))
                            {
                                value4 -= client.CalculateValue(chapters[0].Verses[0].Text);
                            }
                        }
                        ...
                        if (v == 0)
                        {
                            if ((c == 1) || (c == 2) || (c == 28) || (c == 29) || (c == 30) || (c == 31))
                            {
                                value4 -= client.CalculateValue("الم");
                            }
                            else if ((c == 6))
                            {
                                value4 -= client.CalculateValue("المص");
                            }
                            else if ((c == 9) || (c == 10) || (c == 11) || (c == 13) || (c == 14))
                            {
                                value4 -= client.CalculateValue("الر");
                            }
                            else if ((c == 12))
                            {
                                value4 -= client.CalculateValue("المر");
                            }
                            else if ((c == 18))
                            {
                                value4 -= client.CalculateValue("كهيعص");
                            }
                            else if ((c == 19))
                            {
                                value4 -= client.CalculateValue("طه");
                            }
                            else if ((c == 25) || (c == 27))
                            {
                                value4 -= client.CalculateValue("طسم");
                            }
                            else if ((c == 26))
                            {
                                value4 -= client.CalculateValue("طس");
                            }
                            else if ((c == 35))
                            {
                                value4 -= client.CalculateValue("يس");
                            }
                            else if ((c == 36))
                            {
                                value4 -= client.CalculateValue("ص");
                            }
                            else if ((c == 39) || (c == 40) || (c == 41) || (c == 42) || (c == 43) || (c == 44) || (c == 45))
                            {
                                value4 -= client.CalculateValue("حم");
                            }
                            else if ((c == 49))
                            {
                                value4 -= client.CalculateValue("ق");
                            }
                            else if ((c == 67))
                            {
                                value4 -= client.CalculateValue("ن");
                            }
                        }
                        else if (v == 1)
                        {
                            if ((c == 41)) // in chapter 42, verse 2
                            {
                                value4 -= client.CalculateValue("عسق");
                            }
                        }
                    }
                    str.Append(value4.ToString() + "\t");
                    if (IsMatchMethod(value4))
                    {
                        matching_value4_count++;
                        str.Append("1" + "\t");
                    }
                    else
                    {
                    ...
                    if (max_matching_value1_count < matching_value1_count)
                    {
                        max_matching_value1_count = matching_value1_count;
                        max_matching_value1_count_numerology_system_name = numerology_system_name;
                    }
                    if (max_matching_value2_count < matching_value2_count)
                    {
                        max_matching_value2_count = matching_value2_count;
                        max_matching_value2_count_numerology_system_name = numerology_system_name;
                    }
                    if (max_matching_value3_count < matching_value3_count)
                    {
                        max_matching_value3_count = matching_value3_count;
                        max_matching_value3_count_numerology_system_name = numerology_system_name;
                    }
                    if (max_matching_value4_count < matching_value4_count)
                    {
                        max_matching_value4_count = matching_value4_count;
                        max_matching_value4_count_numerology_system_name = numerology_system_name;
                    }

                    str.Append(IsDynamic.ToString() + "\t" + AddToLetterLNumber.ToString() + "\t" + AddWordNumberInVerse.ToString() + "\t" + AddVerseNumberInChapter.ToString() + "\t" + AddToLetterVWLNumber.ToString() + "\t" + AddToLetterLWVNumber.ToString() + "\t" + AddToLetterVWLDistance.ToString() + "\t" + AddToLetterLWVDistance.ToString() + "\t" + numerology_system_name.Replace("_", "\t") + "\r\n");
                }

                str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");
                str.Append("Total" + "\t"
                + "\t" + "\t" + matching_value1_count + "\t" + "\t" + matching_value2_count + "\t" + "\t" + matching_value3_count + "\t" + "\t" + matching_value4_count
                + "\t" + IsDynamic.ToString() + "\t" + AddToLetterLNumber.ToString() + "\t" + AddWordNumberInVerse.ToString() + "\t" + AddVerseNumberInChapter.ToString() + "\t" + AddToLetterVWLNumber.ToString() + "\t" + AddToLetterLWVNumber.ToString() + "\t" + AddToLetterVWLDistance.ToString() + "\t" + AddToLetterLWVDistance.ToString() + "\t" + numerology_system_name.Replace("_", "\t") + "\r\n");
                str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");
                str.Append("\r\n");
            }
        }

        string current_dynamic_add_flags = client.IsDynamic.ToString() + "\t" + client.AddToLetterLNumber.ToString() + "\t" + client.AddToLetterWNumber.ToString() + "\t" + client.AddToLetterVNumber.ToString() + "\t" + client.AddToLetterCNumber.ToString() + "\t" + client.AddToLetterLDistance.ToString() + "\t" + client.AddToLetterWDistance.ToString() + "\t" + client.AddToLetterVDistance.ToString() + "\t" + client.AddToLetterCDistance.ToString() + "\t" + client.AddToWordWNumber.ToString() + "\t" + client.AddToWordVNumber.ToString() + "\t" + client.AddToWordCNumber.ToString() + "\t" + client.AddToWordWDistance.ToString() + "\t" + client.AddToWordVDistance.ToString() + "\t" + client.AddToWordCDistance.ToString() + "\t" + client.AddToVerseVNumber.ToString() + "\t" + client.AddToVerseCNumber.ToString() + "\t" + client.AddToVerseVDistance.ToString() + "\t" + client.AddToVerseCDistance.ToString() + "\t" + client.AddToChapterCNumber.ToString();
        str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");
        str.Append(current_dynamic_add_bits + "\t" + "Normal" + "\t" + "NoBism" + "\t" + "NoInit" + "\t" + "NoBoth" + "\t" + "Dynamic" + "\t" + "Letter" + "\t" + "Word" + "\t" + "Verse" + "\t" + "Chapter" + "\t" + "TextMode" + "\t" + "LetterOrder" + "\t" + "LetterValues" + "\r\n");
        str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");
        str.Append("Max" + "\t" + max_matching_value1_count + "\t" + "\t" + "\t" + "\t" + current_dynamic_add_flags + "\t" + max_matching_value1_count_numerology_system_name.Replace("_", "\t") + "\r\n");
        str.Append("Max" + "\t" + "\t" + max_matching_value2_count + "\t" + "\t" + "\t" + current_dynamic_add_flags + "\t" + max_matching_value2_count_numerology_system_name.Replace("_", "\t") + "\r\n");
        str.Append("Max" + "\t" + "\t" + "\t" + max_matching_value3_count + "\t" + "\t" + current_dynamic_add_flags + "\t" + max_matching_value3_count_numerology_system_name.Replace("_", "\t") + "\r\n");
        str.Append("Max" + "\t" + "\t" + "\t" + "\t" + max_matching_value4_count + "\t" + current_dynamic_add_flags + "\t" + max_matching_value4_count_numerology_system_name.Replace("_", "\t") + "\r\n");
        str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");

        filename = filename.Insert(filename.Length - 4, "_" + max_matching_value1_count + "." + max_matching_value2_count + "." + max_matching_value3_count + "." + max_matching_value4_count);
        string path = s_research_directory + "/" + filename;
        PublicStorage.SaveText(path, str.ToString());
        PublicStorage.DisplayFile(path);
    }

    private static void ___________________________________________(Client client, string extra)
    {
    }
    private static void FindMaxDiffOddSystem(Client client, string extra)
    {
        DoFindMaxDiffSystem(client, Numbers.IsOdd);
    }
    private static void FindMaxDiffEvenSystem(Client client, string extra)
    {
        DoFindMaxDiffSystem(client, Numbers.IsEven);
    }
    private static void FindMaxDiffGeometricSystem(Client client, string extra)
    {
        DoFindMaxDiffSystem(client, Numbers.IsTriangular);
        DoFindMaxDiffSystem(client, Numbers.IsSquare);
        DoFindMaxDiffSystem(client, Numbers.IsPentagonal);
        DoFindMaxDiffSystem(client, Numbers.IsHexagonal);
        DoFindMaxDiffSystem(client, Numbers.IsHeptagonal);
        DoFindMaxDiffSystem(client, Numbers.IsOctagonal);
        DoFindMaxDiffSystem(client, Numbers.IsNonagonal);
        DoFindMaxDiffSystem(client, Numbers.IsDecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsHendecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsDodecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsTridecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsTetradecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsPentadecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsHexadecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsHeptadecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsOctadecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsNonadecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsIcosagonal);
        DoFindMaxDiffSystem(client, Numbers.IsIcosihenagonal);
        DoFindMaxDiffSystem(client, Numbers.IsIcosidigonal);
        DoFindMaxDiffSystem(client, Numbers.IsIcositrigonal);
        DoFindMaxDiffSystem(client, Numbers.IsIcositetragonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredTriangular);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredSquare);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredPentagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredHexagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredHeptagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredOctagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredNonagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredDecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredHendecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredDodecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredTridecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredTetradecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredPentadecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredHexadecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredHeptadecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredOctadecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredNonadecagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredIcosagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredIcosihenagonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredIcosidigonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredIcositrigonal);
        DoFindMaxDiffSystem(client, Numbers.IsCenteredIcositetragonal);
        DoFindMaxDiffSystem(client, Numbers.IsTetrahedral);
        DoFindMaxDiffSystem(client, Numbers.IsPyramidal);
        DoFindMaxDiffSystem(client, Numbers.IsCubic);
    }
    private static void FindMaxDiffPrimeSystem(Client client, string extra)
    {
        DoFindMaxDiffSystem(client, Numbers.IsPrime);
    }
    private static void FindMaxDiffAdditivePrimeSystem(Client client, string extra)
    {
        DoFindMaxDiffSystem(client, Numbers.IsAdditivePrime);
    }
    private static void FindMaxDiffPurePrimeSystem(Client client, string extra)
    {
        DoFindMaxDiffSystem(client, Numbers.IsPurePrime);
    }
    private static void FindMaxDiffCompositeSystem(Client client, string extra)
    {
        DoFindMaxDiffSystem(client, Numbers.IsComposite);
    }
    private static void FindMaxDiffAdditiveCompositeSystem(Client client, string extra)
    {
        DoFindMaxDiffSystem(client, Numbers.IsAdditiveComposite);
    }
    private static void FindMaxDiffPureCompositeSystem(Client client, string extra)
    {
        DoFindMaxDiffSystem(client, Numbers.IsPureComposite);
    }
    private static void FindMaxDiffMersennePrimesSystem(Client client, string extra)
    {
        DoFindMaxDiffSystem(client, Numbers.IsMersennePrime);
    }
    private static void FindMaxDiffFibonacciSystem(Client client, string extra)
    {
        DoFindMaxDiffSystem(client, Numbers.IsFibonacci);
    }
    private static void FindMaxDiffLog2System(Client client, string extra)
    {
        DoFindMaxDiffSystem(client, Numbers.IsLog2);
    }
    private static void FindMaxDiffLog10System(Client client, string extra)
    {
        DoFindMaxDiffSystem(client, Numbers.IsLog10);
    }
    private static void DoFindMaxDiffSystem(Client client, IsMatchDelegate IsMatchMethod)
    {
        if (client == null) return;
        if (client.Selection == null) return;
        ...
        string MatchingType = IsMatchMethod.Method.Name.Remove(0, 2); // remove "Is"
        string filename = "FindMaxDiff" + MatchingType + "System" + Globals.OUTPUT_FILE_EXT;
        ...
        long maxmax_matching_value1_value3_count_diff = 0;
        long maxmax_matching_value2_value4_count_diff = 0;
        string maxmax_matching_value1_value3_count_diff_numerology_system_name = "";
        string maxmax_matching_value2_value4_count_diff_numerology_system_name = "";
        string maxmax_matching_value1_value3_count_diff_dynamic_add_flags = "false, false, false, false, false, false, false, false";
        string maxmax_matching_value2_value4_count_diff_dynamic_add_flags = "false, false, false, false, false, false, false, false";
        ...
        for (int i = 0; i < PERMUTATIONS; i++)
        {
            ...
            long max_matching_value1_value3_count_diff = 0;
            long max_matching_value2_value4_count_diff = 0;
            string max_matching_value1_value3_count_diff_numerology_system_name = "";
            string max_matching_value2_value4_count_diff_numerology_system_name = "";
            DoDoFindMaxDiffSystem(client,
                                  IsMatchMethod,
                                  filename,
                                  numerology_system,
                                  ref max_matching_value1_value3_count_diff,
                                  ref max_matching_value2_value4_count_diff,
                                  ref max_matching_value1_value3_count_diff_numerology_system_name,
                                  ref max_matching_value2_value4_count_diff_numerology_system_name);

            if (maxmax_matching_value1_value3_count_diff < max_matching_value1_value3_count_diff)
            {
                maxmax_matching_value1_value3_count_diff = max_matching_value1_value3_count_diff;
                maxmax_matching_value1_value3_count_diff_numerology_system_name = max_matching_value1_value3_count_diff_numerology_system_name;
                maxmax_matching_value1_value3_count_diff_dynamic_add_flags = IsDynamic.ToString() + "\t" + client.AddToLetterLNumber.ToString() + "\t" + AddWordNumberInVerse.ToString() + "\t" + AddVerseNumberInChapter.ToString() + "\t" + AddToLetterVWLNumber.ToString() + "\t" + AddToLetterLWVNumber.ToString() + "\t" + AddToLetterVWLDistance.ToString() + "\t" + AddToLetterLWVDistance.ToString();
            }
            if (maxmax_matching_value2_value4_count_diff < max_matching_value2_value4_count_diff)
            {
                maxmax_matching_value2_value4_count_diff = max_matching_value2_value4_count_diff;
                maxmax_matching_value2_value4_count_diff_numerology_system_name = max_matching_value2_value4_count_diff_numerology_system_name;
                maxmax_matching_value2_value4_count_diff_dynamic_add_flags = client.IsDynamic.ToString() + "\t" + client.AddToLetterLNumber.ToString() + "\t" + client.AddToLetterWNumber.ToString() + "\t" + client.AddToLetterVNumber.ToString() + "\t" + client.AddToLetterCNumber.ToString() + "\t" + client.AddToLetterLDistance.ToString() + "\t" + client.AddToLetterWDistance.ToString() + "\t" + client.AddToLetterVDistance.ToString() + "\t" + client.AddToLetterCDistance.ToString() + "\t" + client.AddToWordWNumber.ToString() + "\t" + client.AddToWordVNumber.ToString() + "\t" + client.AddToWordCNumber.ToString() + "\t" + client.AddToWordWDistance.ToString() + "\t" + client.AddToWordVDistance.ToString() + "\t" + client.AddToWordCDistance.ToString() + "\t" + client.AddToVerseVNumber.ToString() + "\t" + client.AddToVerseCNumber.ToString() + "\t" + client.AddToVerseVDistance.ToString() + "\t" + client.AddToVerseCDistance.ToString() + "\t" + client.AddToChapterCNumber.ToString();
            }
        ...
        str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");
        str.Append("Total" + "\t" + "NormalDiff" + "\t" + "NoBismDiff" + "\t" + "Dynamic" + "\t" + "Letter" + "\t" + "Word" + "\t" + "Verse" + "\t" + "Chapter" + "\t" + "TextMode" + "\t" + "LetterOrder" + "\t" + "LetterValues" + "\r\n");
        str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");
        str.Append("MaxMax" + "\t" + maxmax_matching_value1_value3_count_diff + "\t" + "\t" + maxmax_matching_value1_value3_count_diff_dynamic_add_flags + "\t" + maxmax_matching_value1_value3_count_diff_numerology_system_name.Replace("_", "\t") + "\r\n");
        str.Append("MaxMax" + "\t" + "\t" + maxmax_matching_value2_value4_count_diff + "\t" + maxmax_matching_value2_value4_count_diff_dynamic_add_flags + "\t" + maxmax_matching_value2_value4_count_diff_numerology_system_name.Replace("_", "\t") + "\r\n");
        str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");

        filename = filename.Insert(filename.Length - 4, "_" + maxmax_matching_value1_value3_count_diff + "." + maxmax_matching_value2_value4_count_diff);
        string path = s_research_directory + "/" + filename;
        PublicStorage.SaveText(path, str.ToString());
        PublicStorage.DisplayFile(path);
    ...
    private static void DoDoFindMaxDiffSystem(Client client, IsMatchDelegate IsMatchMethod,
                                              string filename,
                                              NumerologySystem numerology_system,
                                              ref long max_matching_value1_value3_count_diff,
                                              ref long max_matching_value2_value4_count_diff,
                                              ref string max_matching_value1_value3_count_diff_numerology_system_name,
                                              ref string max_matching_value2_value4_count_diff_numerology_system_name)
    {
        if (client == null) return;
        if (client.Selection == null) return;

        string current_dynamic_add_bits =
        (IsDynamic ? 1 : 0).ToString() +
        (AddToLetterLNumber ? 1 : 0).ToString() +
        (AddWordNumberInVerse ? 1 : 0).ToString() +
        (AddVerseNumberInChapter ? 1 : 0).ToString() +
        (AddToLetterVWLNumber ? 1 : 0).ToString() +
        (AddToLetterLWVNumber ? 1 : 0).ToString() +
        (AddToLetterVWLDistance ? 1 : 0).ToString() +
        (AddToLetterLWVDistance ? 1 : 0).ToString();
        ...
        client.AddToLetterLNumber = AddToLetterLNumber;
        client.AddWordNumberInVerse = AddWordNumberInVerse;
        client.AddVerseNumberInChapter = AddVerseNumberInChapter;
        client.AddToLetterVWLNumber = AddToLetterVWLNumber;
        client.AddToLetterLWVNumber = AddToLetterLWVNumber;
        client.AddToLetterVWLDistance = AddToLetterVWLDistance;
        client.AddToLetterLWVDistance = AddToLetterLWVDistance;
        ...
        foreach (string numerology_system_name in numerology_system_names)
        {
            ...
            if ((client.TextMode != null) && (client.TextMode.StartsWith("Simplified")))
            {
                ...
                long matching_value3_count = 0;
                long matching_value4_count = 0;
                long matching_value1_value3_count_diff = 0;
                long matching_value2_value4_count_diff = 0;
                ...
                for (int c = 0; c < chapters.Count; c++)
                {
                       ...
                       )
                    {
                        ...
                        long value2 = 0; // without bismAllah - without bismAllah and Init
                        for (int v = 0; v < chapters[c].Verses.Count; v++)
                        {
                            value2 += chapters[c].Verses[v].Value;
                            if (v == 0)
                        ...
                        matching_value1_value3_count_diff = Math.Abs(matching_value1_count - matching_value3_count);
                        if (max_matching_value1_value3_count_diff < matching_value1_value3_count_diff)
                        {
                            max_matching_value1_value3_count_diff = matching_value1_value3_count_diff;
                            max_matching_value1_value3_count_diff_numerology_system_name = numerology_system_name;
                        }

                        matching_value2_value4_count_diff = Math.Abs(matching_value2_count - matching_value4_count);
                        if (max_matching_value2_value4_count_diff < matching_value2_value4_count_diff)
                        {
                            max_matching_value2_value4_count_diff = matching_value2_value4_count_diff;
                            max_matching_value2_value4_count_diff_numerology_system_name = numerology_system_name;
                        }
        ...
        string current_dynamic_add_flags = IsDynamic.ToString() + "\t" + AddToLetterLNumber.ToString() + "\t" + AddWordNumberInVerse.ToString() + "\t" + AddVerseNumberInChapter.ToString() + "\t" + AddToLetterVWLNumber.ToString() + "\t" + AddToLetterLWVNumber.ToString() + "\t" + AddToLetterVWLDistance.ToString() + "\t" + AddToLetterVWLNumber.ToString() + "\t" + AddToLetterLWVNumber.ToString() + "\t" + AddToLetterVWLDistance.ToString() + "\t" + AddToLetterLWVDistance.ToString();

        str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");
        str.Append(current_dynamic_add_bits + "\t" + "NormalDiff" + "\t" + "NoBismDiff" + "\t" + "Dynamic" + "\t" + "Letter" + "\t" + "Word" + "\t" + "Verse" + "\t" + "Chapter" + "\t" + "TextMode" + "\t" + "LetterOrder" + "\t" + "LetterValues" + "\r\n");
        str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");
        str.Append("Max" + "\t" + max_matching_value1_value3_count_diff + "\t" + "\t" + current_dynamic_add_flags + "\t" + max_matching_value1_value3_count_diff_numerology_system_name.Replace("_", "\t") + "\r\n");
        str.Append("Max" + "\t" + "\t" + max_matching_value2_value4_count_diff + "\t" + current_dynamic_add_flags + "\t" + max_matching_value2_value4_count_diff_numerology_system_name.Replace("_", "\t") + "\r\n");
        str.Append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" + "\r\n");

        filename = filename.Insert(filename.Length - 4, "_" + max_matching_value1_value3_count_diff + "." + max_matching_value2_value4_count_diff);
        string path = s_research_directory + "/" + filename;
        PublicStorage.SaveText(path, str.ToString());
        PublicStorage.DisplayFile(path);
    }

    private static void ____________________________________________(Client client, string extra)
    {
    }
    private static void FindAllMaxMatchingSystems(Client client, string extra)
    {
        if (client == null) return;
        if (client.Selection == null) return;
        ...
        Console.WriteLine("FindAllMaxMatchingSystems took " + elapsed_time);
    }
    private static void FindAllMaxDiffMatchingSystems(Client client, string extra)
    {
        if (client == null) return;
        if (client.Selection == null) return;
        ...
        DoFindMaxDiffSystem(client, Numbers.IsLog10);
        TimeSpan elapsed_time = DateTime.Now - start_time;
        Console.WriteLine("FindAllMaxDiffMatchingSystems took " + elapsed_time);
    }
    */
    ...
    private class NumerologySystem
    {
        ...
        public bool IsHighlightedText = false;
    ...
    private static bool s_previous_numerology_system_is_dynamic;
    private static bool s_previous_numerology_system_is_highlighted_text;
    private static long CalculateBismAllahAndAlFatihaDifference(ref NumerologySystem numerology_system, NumberType index_type)
    {
        ...
        if (numerology_system != null)
        {
            ...
            if (book != null)
            {
                // only update if numerology system name OR is_dynamic OR is_highlighted_text has changed
                if (
                    (numerology_system.Name == Client.DEFAULT_NUMEROLOGY_SYSTEM)
                    ||
                    (numerology_system.Name != s_previous_numerology_system_name)
                    ||
                    (numerology_system.IsDynamic != s_previous_numerology_system_is_dynamic)
                    ||
                    (numerology_system.IsHighlightedText != s_previous_numerology_system_is_highlighted_text)
                   )
                {
                    s_previous_numerology_system_name = numerology_system.Name;
                    s_previous_numerology_system_is_dynamic = numerology_system.IsDynamic;
                    s_previous_numerology_system_is_highlighted_text = numerology_system.IsHighlightedText;

                    if (numerology_system.IsDynamic)
                    {
                        if (numerology_system.IsHighlightedText)
                        {
                            // CurrentText-wide numerology system (bismAllah)
                            Client.UpdateNumerologySystems(numerology_system.TextMode, book.Verses[0].GetText(numerology_system.TextMode), true);
                        }
                        else
                        {
                            // Selection-wide numerology system (surat Al-Fatiha)
                            Client.UpdateNumerologySystems(numerology_system.TextMode, book.Chapters[0].GetText(numerology_system.TextMode), true);
                        }
                    }
                    else
                    {
                        // Book-wide numerology system
                        Client.UpdateNumerologySystems(numerology_system.TextMode, book.GetText(numerology_system.TextMode), false);
                    }
