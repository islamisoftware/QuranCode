...
namespace Calculator
{
    ...
    public partial class ParseTreeEvaluator : ParseTree
    {
        ...
        protected override object EvaluateStart(ParseTree tree, params object[] paramlist)
        {
            return this.GetValue(tree, TokenType.Expression, 0);
        }

        protected override object EvaluateUnaryExpression(ParseTree tree, params object[] paramlist)
        {
        ...
        protected override object EvaluateParams(ParseTree tree, params object[] paramlist)
        {
            ...
            for (int i = 0; i < nodes.Count; i += 2)
            {
                ...
                {
                    object val = nodes[i].Evaluate(tree, paramlist);
                    parameters.Add(val);
                }
            }
            return parameters;
        ...
        protected override object EvaluatePrimaryExpression(ParseTree tree, params object[] paramlist)
        {
            TokenType type = this.nodes[0].Token.Type;
            ...
            tree.Errors.Add(new ParseError("Illegal EvaluatePrimaryExpression format", 1097, this));
            return null;
        }

        protected override object EvaluateParenthesizedExpression(ParseTree tree, params object[] paramlist)
        {
            return this.GetValue(tree, TokenType.Expression, 0);
        }

        protected override object EvaluatePowerExpression(ParseTree tree, params object[] paramlist)
        {
            ...
            for (int i = 1; i < nodes.Count; i += 2)
            {
                ...
                object val = nodes[i + 1].Evaluate(tree, paramlist);
                if (token.Type == TokenType.POWER)
                {
                    if (
                        (Convert.ToInt64(result) != Convert.ToDouble(result))
                        ||
                        (Convert.ToInt64(val) != Convert.ToDouble(val))
                       )
                    {
                        return Math.Pow(Convert.ToDouble(result), Convert.ToDouble(val));
                    }
                    else // use integral maths instead to avoid silent overflow
                    {
                        long number = Convert.ToInt64(result);
                        long power = Convert.ToInt64(val);
                        long x = 1L;
                        for (long count = 0; count < power; count++)
                        {
                            x *= number;
                        }
                        result = x;
        ...
        protected override object EvaluateMultiplicativeExpression(ParseTree tree, params object[] paramlist)
        {
        ...
        protected override object EvaluateAdditiveExpression(ParseTree tree, params object[] paramlist)
        {
        ...
        protected override object EvaluateConcatEpression(ParseTree tree, params object[] paramlist)
        {
        ...
        protected override object EvaluateRelationalExpression(ParseTree tree, params object[] paramlist)
        {
        ...
        protected override object EvaluateEqualityExpression(ParseTree tree, params object[] paramlist)
        {
        ...
        protected override object EvaluateConditionalAndExpression(ParseTree tree, params object[] paramlist)
        {
        ...
        protected override object EvaluateConditionalOrExpression(ParseTree tree, params object[] paramlist)
        {
        ...
        protected override object EvaluateAssignmentExpression(ParseTree tree, params object[] paramlist)
        {
                ...
                && nodes[3].Token.Type == TokenType.COLON)
            {
                if (Convert.ToBoolean(result))
                    result = nodes[2].Evaluate(tree, paramlist); // return 1st argument
                else
                    result = nodes[4].Evaluate(tree, paramlist); // return 2nd argumen
            }
            return result;
        }
        ...
        protected override object EvaluateLiteral(ParseTree tree, params object[] paramlist)
        {
            TokenType type = this.nodes[0].Token.Type;
        ...
        protected override object EvaluateIntegerLiteral(ParseTree tree, params object[] paramlist)
        {
        ...
        protected override object EvaluateRealLiteral(ParseTree tree, params object[] paramlist)
        {
        ...
        protected override object EvaluateStringLiteral(ParseTree tree, params object[] paramlist)
        {
