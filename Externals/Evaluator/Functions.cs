...
namespace Calculator
{
    public class Functions : Dictionary<string, Function>
    {
        ...
        //}
        public static object Median(object[] ps)
        {
            ...
            if (count % 2 == 0)
            {
                ...
                double middleElement1 = Convert.ToDouble(ordered[(count / 2) - 1]);
                double middleElement2 = Convert.ToDouble(ordered[(count / 2)]);
                medianValue = (middleElement1 + middleElement2) / 2;
            }
            else
            {
                // count is odd, simply get the middle element.
                medianValue = Convert.ToDouble(ordered[(count / 2)]);
            }
        ...
        private static object Help(object[] ps)
        {
            ...
            help.AppendLine("The following functions are supported:");
            foreach (string key in Functions.Defaults.Keys)
            {
